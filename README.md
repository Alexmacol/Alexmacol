...
- 🏗️ **Background:** 15 anos de de experiência como programador e analista de sistemas em mainframe — desenvolvimento, processamento batch e integração de sistemas de missão crítica.
...
- 🟢 **Disponível** para oportunidades como **Web Developer Full-Stack Entry Level**.
